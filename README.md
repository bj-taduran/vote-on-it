...
| **API throttling** | API Gateway default route settings: 50-request burst limit, 20 rps sustained. Lambda reserved concurrency is capped (default 100) to limit blast radius. |
